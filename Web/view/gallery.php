	...
	<div class="container">
		<hr class="mt-2 mb-5">
				...
				<div class="col-lg-6 col-md-4 col-6">
		    			<a href="acc.html" class="d-block mb-4 h-100">
						<img class="img-fluid img-thumbnail" id="gal" src="../public/img/acc.png" alt="">
		        			</a>
		  		</div>
		  		<div class="col-lg-6 col-md-4 col-6">
		   			 <a href="acc1.html" class="d-block mb-4 h-100">
						<img class="img-fluid img-thumbnail" id="gal" src="../public/img/acc1.png" alt="">
		        			</a>
		  		</div>
		  		<div class="col-lg-6 col-md-4 col-6">
		    			<a href="membre.html" class="d-block mb-4 h-100">
						<img class="img-fluid img-thumbnail"  id="gal" src="../public/img/membre.png" alt="">
		        			</a>
		  		</div>
		  		<div class="col-lg-6 col-md-4 col-6">
		    			<a href="cont.html" class="d-block mb-4 h-100">
						<img class="img-fluid img-thumbnail" id="gal" src="../public/img/cont.png" alt="">
		       			</a>
		  		</div>
		  		<div class="col-lg-6 col-md-4 col-6">
		    			<a href="fonc.html" class="d-block mb-4 h-100">
						<img class="img-fluid img-thumbnail" id="gal" src="../public/img/fonc.png" alt="">
		        			</a>
		  		</div>
		  		<div class="col-lg-6 col-md-4 col-6">
		    			<a href="lib.html" class="d-block mb-4 h-100">
						<img class="img-fluid img-thumbnail" id="gal" src="../public/img/lib.png" alt="">
		        			</a>
		  		</div>
		  		<div class="col-lg-6 col-md-4 col-6">
		    			<a href="sup.html" class="d-block mb-4 h-100">
						<img class="img-fluid img-thumbnail" id="gal" src="../public/img/sup.png" alt="">
		        			</a>
		  		</div>
		  		<div class="col-lg-6 col-md-4 col-6">
		    			<a href="nt.html" class="d-block mb-4 h-100">
						<img class="img-fluid img-thumbnail" id="gal" src="../public/img/nt.png" alt="">
		        			</a>
		  		</div>
			</div>      
	</div>
